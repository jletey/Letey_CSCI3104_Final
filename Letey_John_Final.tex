...
In my algorithm, which is included in part c, all I do is add a super source and a super sink and connect each person to the super source with specified capacities and lower bounds and the issues to the super sink with a specified capacities and lower bounds.
% ----------------------------  PART 2B  -----------------------------------
...
As Chen said, I called the built in NetworkX function.
% ----------------------------  PART 2E  -----------------------------------
...
\textbf{Base Case:} $m = 1$ \\
When $m = 1$, there are $n = 2m + 1 = 3$ people on the field. Since the distances between the pairs of people are distinct, the distance between person 1 and 3 and the distance between person 2 and 3 are both different, and greater than the distance between person 1 and 2. Thus, persons 1 and 2 throw balloons at each other, and person 3 throws a balloon at either person 1 or 2, implying person 3 never gets hit. \\
\textbf{Inductive Step:} Assume that the predicate $f(k)$ is true for an arbitary integer k. Prove that the predicate $P(k + 1)$ is true \\
Suppose that we have $n = 2k + 3$ people on the field with distinct distances between people. Let's define person 1 and person 2 to be a closest pair of people in the group of people. When each person throughs a balloon at another, person 1 and person 2 through balloons at each other. Thus, we have two cases, where \textit{i}, another person throughs a balloon at either person 1 or person 2 and, \textit{ii}, no other person throughs a balloon at either person 1 or person 2 \\
\textit{Case 1:} Because person 1 and person 2 throw balloons at each other, and someone else throughs a balloon at either person 1 or person 2, at least 3 balloons are thrown at person 1 and person 2, which implies at most $2k$ balloons are thrown at the remaining $2k + 1$ people. Therefore, throws at least one balloon at each person, there will still be a least one person standing. \\
