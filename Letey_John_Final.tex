...
%  17         j = j + 1
% \end{verbatim}
% The pseudocode for the \texttt{Merge} procedure will need a lot of modification, unlike the \texttt{Merge-Sort} function.
In the problem, we're given the restraints of the algorithm has to be divide-and-conquer and its run-time has to be $\mathcal{O}(n\log(n))$.
% ----------------------------  PART 1B  -----------------------------------
