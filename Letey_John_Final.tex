...
Merge-Sort(A, p, r)
  ...
  5     Merge(A, p, q, r)
\end{verbatim}
I now have to modify the above pseudocode to make the algorithm count how many reverses there are in the array. I also have to modify the pseudocode, so that it returns the count instead of just being a void function.
% ----------------------------  PART 1B  -----------------------------------
